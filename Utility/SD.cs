...
namespace YemekSiparisWeb.Utility
{
    ...
    {
        public const string DefaultFoodImage = "default_food.png";//wwwroot ta images klasorunde yukledik bu resmi.
        ...
        public static string ConvertToRawHtml(string source)//description alanı html.raw tipinde oldugu icin bu fonskiyon ile stringe donusturduk.
        {
